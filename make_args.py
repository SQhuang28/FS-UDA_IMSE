...
def args():
    ...
    parser.add_argument('--dataset_dir', default='/home/hsq/NAS/Projects/datasets/MMMMdataset', help='/miniImageNet')
    parser.add_argument('--split_PATH', type=str, default='/home/hsq/NAS/Projects/mini-imagenet-split')
    ...
    parser.add_argument('--bn_epoch', type=int, default=1, help='the number of BN epoch')
