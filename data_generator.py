...
def sample_task(data_model, raw_class_num, model, query_num_per_class_per_model=1, class_num=5,
                    support_num_per_class_per_model=1, train_or_test='train'):
    """
...
class DataGenerator(object):
    def __init__(self, mode, datasource, imagesize, episode, way_num, support_num, query_num, data_dir, split_PATH, source_domain=None, target_domain=None, s2p=False):
    ...
    def generator_tasks(self,):
        ...
        for _ in (range(tasknum)):
            task = sample_task(self.data_model, self.raw_class_num, model, query_num_per_class_per_model=self.query_num,
                                     ...
                                     support_num_per_class_per_model=self.support_num, train_or_test=self.mode)
